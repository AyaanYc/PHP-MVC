...
<head>
    ...
    <style>
        ...
        .container-md { background-color: yellowgreen;}
        .container-lg { background-color: pink;}
        .container-xl { background-color: gray;}
        .container-xxl { background-color: purple;}
...
<body>
    ...
    <div class="container-fluid">100% wide until extra extra large breakpoint 전체</div>
</body>
</html>